...
# Import directly from the file path since module name has hyphen
import importlib.util
spec = importlib.util.spec_from_file_location(
    "MarketEngineManager", 
    os.path.join(backend_dir, "market-engine", "manager", "MarketEngineManager.py")
)
market_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(market_module)
MarketEngineManager = market_module.MarketEngineManager
